...
public class View_Lec_Course extends javax.swing.JFrame {
    
    private Connection con;
    
    
    public View_Lec_Course() {
        initComponents();
        showUser();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(Table, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 640, 130));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(291, 40, 190, -1));
        ...
        getContentPane().add(sub, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 320, -1, 20));

        name.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 320, 300, 30));

        noticeBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/interface1.jpg"))); // NOI18N
        noticeBack.setOpaque(true);
    ...
    private void NoticeExitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NoticeExitMouseClicked
        Lec_Course co=new Lec_Course();  // back to the user profiles
        co.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Lec_Course.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Lec_Course().setVisible(true);
            }
        });
    }
