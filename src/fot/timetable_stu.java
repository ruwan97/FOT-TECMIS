 ...
 * @author Ishanka
 */
public class timetable_stu extends javax.swing.JFrame {
   
    /**
     * Creates new form timetable
     */
    public timetable_stu() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(timetable_stu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new timetable_stu().setVisible(true);
            }
        });
    }
